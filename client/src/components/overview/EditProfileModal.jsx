...
export const EditProfileModal = ({ user, onClose, onUpdate }) => {
  ...
  const testConnection = async () => {
    try {
      ...
      const response = await fetch("https://hospital-management-k1xl.onrender.com/api/user/profile", {
        method: "GET",
        headers: {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 relative animate-fadeIn">
        ...
        {success && (
          <div className="mb-4 p-3 bg-sky-50 border border-sky-200 text-sky-700 rounded-lg flex items-center">
