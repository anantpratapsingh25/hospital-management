...
export const PatientStats = ({ data }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="text-center border-transparent p-5 bg-sky-50 rounded-xl shadow">
        <div className="w-24 h-24 mx-auto mb-4">
          <CircularProgressbar
        ...
        <div className="flex items-center justify-center gap-2 text-sky-700 font-semibold mb-1">
