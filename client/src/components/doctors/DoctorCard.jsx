...
export const DoctorCard = ({
  ...
  const getStatusBadge = () => {
    if (doctor.isApproved) {
      return (
        <div className="absolute top-4 right-4 flex items-center bg-sky-100 text-sky-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-3 mb-4">
              ...
              {doctor.location && (
                <span className="inline-flex items-center text-xs text-sky-600 bg-sky-100 px-2.5 py-1 rounded-full">
